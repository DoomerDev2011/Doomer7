	...
	States{
		...
		Select:
			...
			TNT1 A 0
			{
				...
				{
					A_SetInventory( "K7_Dan_Taurus_Ammo", 6 );
					A_SetInventory( "K7_Dan_DemonGun_Ammo", 12 );
			...
			DANF A 1 bright A_WeaponOffset( 100, -30, WOF_INTERPOLATE );
			DANF A 1 bright A_WeaponOffset( 70, 2, WOF_INTERPOLATE);
			DANF A 1 bright A_WeaponOffset( 50, 18, WOF_INTERPOLATE);
			DANF A 1 bright A_WeaponOffset( 30, 26, WOF_INTERPOLATE);
			DANF A 1 bright A_WeaponOffset( 10, 30, WOF_INTERPOLATE);
		...
		ChargeTubes:
			DANF A 5 A_StartSound( "weapon/tubea", CHAN_AUTO, CHANF_OVERLAP  );
			DANF A 5 A_StartSound( "weapon/tubeb", CHAN_AUTO, CHANF_OVERLAP  );
			TNT1 A 0 A_StartSound( "weapon/dancharge", CHAN_7, CHANF_OVERLAP );
			DANF A 10 A_StartSound( "weapon/tubec", CHAN_AUTO, CHANF_OVERLAP  );
		SpecialFire:
