class SmithSyndicate: DoomPlayer
{
	default
	{
		...
		Player.StartItem "K7_SniperPistol";
		Player.StartItem "K7_Taurus";
		Player.StartItem "K7_Enfield2";
		Player.StartItem "K7_Glock";
		...
		Player.StartItem "K7_TaurusAmmo", 6;
		...
		Player.WeaponSlot 0, "K7_PPK","K7_SniperPistol";
		
        Player.WeaponSlot 1, "K7_Taurus";
        Player.WeaponSlot 2, "K7_Hardballer";
        Player.WeaponSlot 3, "K7_ThrowingKnife";
        Player.WeaponSlot 4, "K7_Enfield2";
        Player.WeaponSlot 5, "K7_Glock";
